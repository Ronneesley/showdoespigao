...
UPDATE questoes SET opcao_correta = 4 WHERE id = 1; 
-- Trocar os updates pros id das questões opcao_corretas
...
UPDATE questoes SET opcao_correta = 10 WHERE id = 3;
...
UPDATE questoes SET opcao_correta = 14 WHERE id = 4;
...
UPDATE questoes SET opcao_correta = 17  WHERE id = 5;
-- 20 
...
UPDATE questoes SET opcao_correta = 23 WHERE id = 6;
...
UPDATE questoes SET opcao_correta = 26 WHERE id = 7;
-- 28
...
UPDATE questoes SET opcao_correta = 29 WHERE id = 8;
-- 32
...
UPDATE questoes SET opcao_correta = 34 WHERE id = 9;
-- 36
...
UPDATE questoes SET opcao_correta = 37 WHERE id = 10;
-- 40
...
UPDATE questoes SET opcao_correta =  41 WHERE id = 11;
-- 44
...
UPDATE questoes SET opcao_correta = 45  WHERE id = 12;
-- 48
...
UPDATE questoes SET opcao_correta = 47 WHERE id = 13;
-- 52
...
UPDATE questoes SET opcao_correta = 58 WHERE id = 16;
-- 64
...
UPDATE questoes SET opcao_correta =  61 WHERE id = 17;
-- 68
...
UPDATE questoes SET opcao_correta = 66  WHERE id = 18;
-- 72
INSERT INTO questoes (descricao, nivel) VALUES ("Assinale, das alternativas abaixo, a única que 
identifica opcao_corretamente a maior e mais usada ferramenta de busca da Internet:", "19");
INSERT INTO opcoes (questao, descricao) VALUES (19, "WhatsApp"),(19, "Microsoft"),(19, "Google"),(19, "Facebook");
UPDATE questoes SET opcao_correta = 71 WHERE id = 19;
-- 76
...
UPDATE questoes SET opcao_correta =  80 WHERE id = 20;
-- 80
...
UPDATE questoes SET opcao_correta = 84 WHERE id = 21;
-- 84
...
UPDATE questoes SET opcao_correta = 85 WHERE id = 22;
-- 88
...
UPDATE questoes SET opcao_correta =  89 WHERE id = 23;
-- 92
...
UPDATE questoes SET opcao_correta = 95 WHERE id = 24;
-- 96
...
UPDATE questoes SET opcao_correta = 98 WHERE id = 25;
-- 100
...
UPDATE questoes SET opcao_correta = 101 WHERE id = 26;
-- 104
...
UPDATE questoes SET opcao_correta = 108 WHERE id = 27;
-- 108
...
UPDATE questoes SET opcao_correta =  110 WHERE id = 28;
-- 112
...
UPDATE questoes SET opcao_correta = 1z
-- 116
...
UPDATE questoes SET opcao_correta = 119 WHERE id = 30;
-- 120
...
UPDATE questoes SET opcao_correta = 122 WHERE id = 31;
-- 124
...
UPDATE questoes SET opcao_correta = 127 WHERE id = 32;
-- 128
...
UPDATE questoes SET opcao_correta = 130 WHERE id = 33;
-- 132
...
UPDATE questoes SET opcao_correta = 135 WHERE id = 34;
