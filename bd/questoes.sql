...
ALTER TABLE questoes ADD FOREIGN KEY (resposta_correta) REFERENCES opcoes(id);
...
-- 64
INSERT INTO questoes (descricao, nivel) VALUES ("Assinale, das alternativas abaixo, a única que identifica inresposta_corretamente um aplicativo típico da Internet", "17");
...
inresposta_corretamente a extensão de arquivo que o MS-WORD suporta para gravar.", "21");
...
-- Adriano:
INSERT INTO questoes (descricao, nivel) VALUES ("Com referência à engenharia de testes e qualidade com foco na identificação de inconsistências entre o propósito de ferramentas de software e as características dos software em desenvolvimento, assinale a opção resposta_correta.", "35");
...
UPDATE questoes SET resposta_correta = 137 WHERE id = 35;
-- 140 letra  b
INSERT INTO questoes (descricao, nivel) VALUES ("Considerando uma organização na qual a abordagem de test driven development (TDD) esteja implementada, assinale a opção resposta_correta.", "36");
...
UPDATE questoes SET resposta_correta = 144 WHERE id = 36;
-- 144 letra d
INSERT INTO questoes (descricao, nivel) VALUES ("Com referência ao fortalecimento da capacidade de teste de software em uma organização produtora de software, assinale a opção resposta_correta acerca da aplicação de métodos e técnicas de teste de software.", "37");
...
UPDATE questoes SET resposta_correta = 145 WHERE id = 37;
-- 148 
...
UPDATE questoes SET resposta_correta = 149 WHERE id = 38; 
-- 152 LETRA A
...
UPDATE questoes SET resposta_correta = 155 WHERE id = 39;
-- 156 LETRA C 
...
UPDATE questoes SET resposta_correta = 157 WHERE id = 40;
-- 160 lETRA A
...
UPDATE questoes SET resposta_correta = 162 WHERE id = 41;
-- 164 LETRA B
...
UPDATE questoes SET resposta_correta = 165 WHERE id = 42;
-- 168 LETRA A
...
UPDATE questoes SET resposta_correta = 169 WHERE id = 43;
-- 172 letra a 
...
UPDATE questoes SET resposta_correta = 176 WHERE id = 44;
-- 176 LETRA D
INSERT INTO questoes (descricao, nivel) VALUES ("De maneira bem simples e objetiva, o sistema operacional refere-se a um ou mais softwares que tem como papel principal gerenciar/administrar todos os recursos presentes em um sistema. Isso abrange desde sistemas de arquivos, passando por componentes do hardware, e até mesmo programas de terceiros. Sobre esse assunto, assinale a alternativa resposta_correta.
", "45");
...
UPDATE questoes SET resposta_correta = 178 WHERE id = 45;
-- 180 LETRA B
...
UPDATE questoes SET resposta_correta = 182 WHERE id = 46;
-- 184 LETRA B
...
UPDATE questoes SET resposta_correta = 185 WHERE id = 47;
-- 188 LETRA A
...
UPDATE questoes SET resposta_correta = 190 WHERE id = 48;
-- 192 letra b
...
UPDATE questoes SET resposta_correta = 193 WHERE id = 48;
-- 196 letra a 
...
UPDATE questoes SET resposta_correta = 197 WHERE id = 49;
-- 200 letra a
...
UPDATE questoes SET resposta_correta = 201 WHERE id = 50;
-- 204 letra a
...
UPDATE questoes SET resposta_correta = 206 WHERE id = 51;
-- 208 letra b
...
UPDATE questoes SET resposta_correta = 212 WHERE id = 52;
-- 212 letra d
...
UPDATE questoes SET resposta_correta = 216 WHERE id = 53;
-- 216 letra d
...
UPDATE questoes SET resposta_correta = 217 WHERE id = 54;
-- 220 letra a
...
UPDATE questoes SET resposta_correta = 222 WHERE id = 55;
-- 224 letra b
...
UPDATE questoes SET resposta_correta = 226 WHERE id = 56;
-- 228 letra c
...
docker ps "),(57, "
docker ps -s");
UPDATE questoes SET resposta_correta = 229 WHERE id = 57;
-- 232 letra a
...
UPDATE questoes SET resposta_correta = 234 WHERE id = 58;
-- 236 letra b
...
apt-get clean ppp");
UPDATE questoes SET resposta_correta = 238 WHERE id = 59;
-- 240 letra b
...
UPDATE questoes SET resposta_correta = 244 WHERE id = 60;
-- 244 letra d
INSERT INTO questoes (descricao, nivel) VALUES ("Sobre a característica da computação em nuvem conhecida como elasticidade rápida, assinale a alternativa resposta_correta.", "61");
...
UPDATE questoes SET resposta_correta = 247 WHERE id = 61;
-- 248 letra c
...
UPDATE questoes SET resposta_correta = 127 WHERE id = 62;
-- 252 letra d
...
UPDATE questoes SET resposta_correta = 254 WHERE id = 63;
-- 256 letra B
...
UPDATE questoes SET resposta_correta = 259 WHERE id = 64;
-- 260 letra C
...
UPDATE questoes SET resposta_correta = 261 WHERE id = 65;
-- 264 letra a 
